...
public class ValorFinal extends IngEconomica{
    ...
    ActionListener oyente3 = new ActionListener() {
        ...
        if(cajatexto1.getText().equals("") || cajatexto2.getText().equals("") || cajatexto2.getText().equals("")){
            JOptionPane.showMessageDialog(null, "No puede haber campos vacíos", "Error", JOptionPane.WARNING_MESSAGE);
                ...
                vp = Integer.parseInt(cajatexto1.getText());
                T = Integer.parseInt(cajatexto2.getText());
                i = Integer.parseInt(cajatexto3.getText());

                vf = vp*(1+i*T);

                eti4.setText("El valor final es de : " + vf + " pesos");
